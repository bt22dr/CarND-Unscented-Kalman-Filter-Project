...
void UKF::AugmentedSigmaPoints(VectorXd &x, MatrixXd* Xsig_out) {
...
void UKF::SigmaPointPrediction(MatrixXd &Xsig_aug, float dt, MatrixXd* Xsig_out) {
...
void UKF::Prediction(double delta_t) {
  ...
  */
  ...
  AugmentedSigmaPoints(x_, &Xsig_aug);
  
  // Get predicted sigma points (apply process model f() on sigma points)
  SigmaPointPrediction(Xsig_aug, delta_t, &Xsig_pred_);
  
  // Calculate predicted state and predicted state covariance matrix
